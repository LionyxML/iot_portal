...
const Home = () => {
  return (
    <Container fluid className="p-0">
      <Container
        fluid
        class="jumbotron jumbotron-fluid p-0 mx-auto "
        style={{
          height: "calc(100vh - 71px)",
          background:
            "url(https://images.pexels.com/photos/3877660/pexels-photo-3877660.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260) no-repeat center center fixed",
      ...
      >
        ...
        >
          <h1 class="display-4">Olá! Você chegou!</h1>
          <p class="lead">
          ...
          <p class="lead">Utilize a barra de navegação para conhecer o site!</p>
        </Container>
      </Container>
      ...
      {/* <Container md className="md mt-3">
        <h2>Olá!</h2>
        <p>
          Você chegou ao portal do laboratório de Energias Renováveis do
          Instituto SENAI em Energia "Comendador Santoro Mirone" de
          Indaiatuba-SP
        </p>
      </Container> */}
      <Container className="mt-3">{/* <Carrossel /> */}</Container>
    </Container>
  );
};
